...
public class CoachRegistration {
            ...
            while (attempt < 3) {
                ...
                try {
                    ...
                    if (inputRole.equals("coach")) {
                        ...
                        System.out.println("Invalid role! Since you are registering, only 'coach' is allowed.");
    ...
    void Connection() {
        try (Connection con = Databaseconnection.getConnection()) {
            ...
            if (rs.next()) {
                user_id = rs.getInt(1); // Set this in CoachRegistration2
            }

            if (choose > 0) {
                System.out.println("Registration Succesfull !");
                CoachRegistration2 cr = new CoachRegistration2(user_id);
                cr.CoachInformation();
                return;
